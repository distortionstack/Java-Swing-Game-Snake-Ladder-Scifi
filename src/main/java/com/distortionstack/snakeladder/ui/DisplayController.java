...
public class DisplayController {
    ...
    // เพิ่มเมธอดนี้ในไฟล์ DisplayController.java
    public void showFinishScreen(String winnerName) {
        FinishedPanel finishedPanel = new FinishedPanel(assetManager, this, winnerName);
        switchTo(finishedPanel);
    }
